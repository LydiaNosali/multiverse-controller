...
public class EventHandler extends BaseMicroserviceVerticle {
	...
	private final NdnetService configService;

	public EventHandler(NdnetService configService) {
	...
	private void notifyFrontend() {
		vertx.eventBus().publish(NdnetService.FROTNEND_ADDRESS, new JsonObject());
	}
}
